...
4. Serve `web/` on a local static server, then open `http://localhost:5500/` for the operations console.
5. Open `android/` in Android Studio for the mobile app.

The web console talks to the backend at `http://localhost:8080/api/`. For the Android emulator, the default development endpoint is `http://10.0.2.2:8080/api/`.
